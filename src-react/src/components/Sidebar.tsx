...
const MENU_ITEMS = [
    { id: 'new-order', icon: Plus, label: 'Nuevo Pedido', color: 'text-manzano-500', bg: 'bg-manzano-50' },
    { id: 'update-rate', icon: ArrowLeftRight, label: 'Actualizar Tasas', color: 'text-blue-500', bg: 'bg-blue-50' },
    { id: 'history', icon: ClipboardList, label: 'Historial', color: 'text-purple-500', bg: 'bg-purple-50' },
    { id: 'clients', icon: Users, label: 'Clientes', color: 'text-cyan-500', bg: 'bg-cyan-50' },
    { id: 'balance', icon: Wallet, label: 'Balance CLP', color: 'text-green-500', bg: 'bg-green-50' },
    { id: 'ves-balance', icon: Landmark, label: 'Balance VES', color: 'text-red-500', bg: 'bg-red-50' },
    { id: 'commissions', icon: DollarSign, label: 'Comisiones', color: 'text-emerald-500', bg: 'bg-emerald-50' },
    { id: 'accounts', icon: Building2, label: 'Cuentas VES', color: 'text-rose-500', bg: 'bg-rose-50' },
    { id: 'reports', icon: BarChart3, label: 'Reportes', color: 'text-indigo-500', bg: 'bg-indigo-50' },
    { id: 'settings', icon: Settings, label: 'Configuración', color: 'text-gray-500', bg: 'bg-gray-50' },
];

export function Sidebar({ isOpen, onClose, onNavigate, onLogout, userEmail }: SidebarProps) {
